...
echo "	</tbody>
	<tfoot>
		<tr><td colspan='8' style='padding:20px 0 10px 0; border:0px;'><span style='margin-right:50px'>统计：".$result['INPUTTER']."</span><span style='margin-right:50px'>查核：".$result['CHECKER']."</span><span style='margin-right:50px'>批准：".$result['APPROVER']."</span><span>付款审核：".$result['PAYCHECKER']."</span></td></tr>
		<tr><td colspan='8' class='printright' style='border:0px;'><span tdata='pageNO'>第###页</span><span tdata='pageCount'>共###页</span></td></tr>
	</tfoot>
	</table>
</body>
</html>";
