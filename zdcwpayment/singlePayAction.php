...
if($FLAG == 'singlePay'){$TOSTAT = '已付款'; $ACT = '单笔付款'; }
if($FLAG == 'cancelSinglePay'){$TOSTAT = '已取消付款'; $ACT = '取消付款';}
...
//开始付款
$query = "UPDATE zdcw_payment_detail SET PAYSTAT='$TOSTAT', PAYER='$login_user', PAYTIME=NOW() WHERE NUM = '$NUM' AND ITEMNO = '$ITEMNO'";
