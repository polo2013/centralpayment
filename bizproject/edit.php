...
if ($chk['ok']){
	...
	//旧数据
	$query = "select * from BIZ_PROJECT where CODE = '$CODE'";
	...
	//开始更新
	$query = "UPDATE BIZ_PROJECT SET NAME='$NAME',ORG='$ORG',NOTE='$NOTE',LASTUPD='$login_user',LASTUPDTIME=NOW(),ORDERNO='$ORDERNO' WHERE CODE='$CODE'";
